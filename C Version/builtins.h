...
/* Command-line: 'C:\\ProgramData\\chocolatey\\lib\\gperf\\tools\\gperf.exe' -c -t '.\\builtins.gperf'  */
...
#endif
static unsigned int
hash_builtins (register const char *str, register size_t len)
{
...
struct Calc_Lookup_Builtin *
get_builtin (register const char *str, register size_t len)
{
  static struct Calc_Lookup_Builtin wordlist[] =
    {
      {""}, {""}, {""},
#line 38 ".\\builtins.gperf"
      {"dup", calc_builtin_dup},
#line 39 ".\\builtins.gperf"
      {"drop", calc_builtin_drop},
#line 37 ".\\builtins.gperf"
      {"type", calc_builtin_type}
    };

  if (len <= MAX_WORD_LENGTH && len >= MIN_WORD_LENGTH)
    {
      register unsigned int key = hash_builtins (str, len);
